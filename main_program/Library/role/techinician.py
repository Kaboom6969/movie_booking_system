...
def view_upcoming_movies(cinema_device_dict : dict=None,movie_code_column_location : int = 1):
    if cinema_device_dict is None:cinema_device_dict = ddf.CINEMA_DEVICE_DICTIONARY
    movie_list : list = ccsf.read_list_from_cache(dictionary_cache= cinema_device_dict)
