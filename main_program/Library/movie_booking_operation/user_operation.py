from ..movie_booking_framework import movie_seats_framework
#测试用 python -m main_program.Library.movie_booking_operation.user_operation

movie_seats_framework.TARGET_DIRECTORY = "Data"
...
def delete_movie(movie_seats_csv : str, movie_list_csv : str) -> None:
    ...
    movie_seats_framework.delete_movie_seats_csv(movie_seats_csv= movie_seats_csv, movie_code=movie_code_input)
